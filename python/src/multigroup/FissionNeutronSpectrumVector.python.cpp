...
void wrapFissionNeutronSpectrumVector( python::module& module, python::module& ) {

  // type aliases
  using Record = njoy::NDItk::multigroup::FissionNeutronSpectrumVector;
