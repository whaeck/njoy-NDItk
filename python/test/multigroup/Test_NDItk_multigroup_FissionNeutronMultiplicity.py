...
# local imports
from NDItk.multigroup import FissionNeutronMultiplicity
from NDItk.multigroup import FissionType

class Test_NDItk_multigroup_FissionNeutronMultiplicity( unittest.TestCase ) :
    """Unit test for the FissionNeutronMultiplicity class."""
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            # verify the record
            self.assertEqual( 'nu_pr', chunk.keyword )
        ...
        chunk = FissionNeutronMultiplicity( type = FissionType.Prompt,
                                            values = [ 2, 2.1, 2.2, 2.3, 2.4, 5, 7 ] )

        verify_chunk( self, chunk )

        # the data is read from a string
        chunk = FissionNeutronMultiplicity.from_string( self.chunk_string, 7 )
